...
class PSODynamic:
    def __init__(self, max_iterations, dynamic_evaluations):
        ...
        archive = ArchiveDynamic.ArchiveDynamic(sum(num_particles), evaluations)
        ...
        for dynamic_iteration in range(1, 1001):
            print("iteration: " + str(dynamic_iteration))
            iteration = 1
            evaluations.update_t(dynamic_iteration)
